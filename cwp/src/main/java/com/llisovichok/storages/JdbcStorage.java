...
/**
 * TODO rewrite method add (change it to boolean)
...
public class JdbcStorage implements Storage {
    ...
    public JdbcStorage() {
        ...
        try {
            ...
            this.connection = DriverManager.getConnection(settings.getValue("jdbc.url"), settings.getValue("jdbc.username"), settings.getValue("jdbc.password"));
    ...
    public void edit(final Integer id, final User user) {
        ...
        try (final PreparedStatement clientStatement = this.connection.prepareStatement("UPDATE clients SET first_name=?, last_name=?, address=?, phone=? WHERE public.clients.uid=?");
            ...
            clientStatement.setString(3, user.getAddress());
            clientStatement.setLong(4, user.getPhoneNumber());
            clientStatement.setInt(5, id.intValue());
            clientStatement.executeUpdate();
            ...
            petStatement.setInt(4, id.intValue());
            petStatement.executeUpdate();
